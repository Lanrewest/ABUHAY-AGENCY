      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center p-8 rounded-xl shadow-lg bg-white/90 border border-gold/30 mt-12">
        ...
        <div className="flex flex-col gap-4 items-center">
          <div className="flex gap-4">
            <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80" alt="Luxury Duplex" className="w-40 h-40 rounded-xl shadow-lg border-4 border-gold object-cover" />
            <img src="https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?auto=format&fit=crop&w=400&q=80" alt="Modern Flat" className="w-40 h-40 rounded-xl shadow-lg border-4 border-primary object-cover" />
          </div>
          <img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80" alt="Prime Land" className="w-80 h-32 rounded-xl shadow-lg border-4 border-accent object-cover" />
        </div>
      </div>
